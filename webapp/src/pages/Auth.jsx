      ...
      <div style={{ maxWidth: '400px', width: '100%' }}>
        ...
        <form onSubmit={handleEmailSubmit}>
          ...
          <input
            ...
            required
            minLength="6"
            style={{ width: '100%', padding: '0.9rem', marginBottom: '1.5rem', borderRadius: '4px', border: '1px solid var(--border)', background: '#202020', color: 'var(--cream)', fontFamily: 'var(--font-sans)' }}
          />
